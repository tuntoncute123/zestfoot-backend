...
export class AdminController {
  ...
  @Get('mining')
  @ApiOperation({ summary: 'Khai phá dữ liệu (Market Basket, RFM, Review Mining)' })
  ...
  @Get('analytics')
  @ApiOperation({ summary: 'Thống kê kết quả kinh doanh và Gamification ROI (DWH)' })
  ...
  async getMlAnalytics(@Query('email') email?: string, @Query('limit') limit?: number) {
